...
##  **As 5 Chains (O "Onde" o pacote está)** 
As tabelas contêm _Chains_ (Cadeias), que correspondem diretamente aos 5 ganchos do Netfilter. O caminho que um pacote percorre depende do seu destino:
...
Há uma nota que explica com um pouco mais de profundidade sobre (Mas só um pouco) - [[Protocolos/NAT]]
